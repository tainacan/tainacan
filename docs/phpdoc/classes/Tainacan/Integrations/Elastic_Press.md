...
* Full name: `\Tainacan\Integrations\Elastic_Press`
...
```php
private static \Tainacan\Integrations\Elastic_Press $instance
```
...
```php
public static get_instance(): \Tainacan\Integrations\Elastic_Press|\Tainacan\Integrations\Elastic_Press_lte4
```
