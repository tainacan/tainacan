                    ...
                    { ( !showTermThumbnail && Array.isArray(termItems) ) ?
                        <div className="term-items-grid">
                            <img
                                ...
                                alt={ termItems[0] && termItems[0].thumbnail_alt ? termItems[0].thumbnail_alt : (termItems[0] && termItems[0].name ? termItems[0].name : '') } />
                            <img
                                    ...
                                    alt={ termItems[1] && termItems[1].thumbnail_alt ? termItems[1].thumbnail_alt : (termItems[1] && termItems[1].name ? termItems[1].name : '') } />
                            <img
                                    ...
                                    alt={ termItems[2] && termItems[2].thumbnail_alt ? termItems[2].thumbnail_alt : (termItems[2] && termItems[2].name ? termItems[2].name : '') } />
                        </div>
                        :
                        <img
                            src={
