...
export default class ItemsModal extends React.Component {
    ...
    fetchItems(selectedItems) {
        ...
        let endpoint = '/collection/' + this.state.collectionId + '/items?'+ qs.stringify({ postin: selectedItems, perpage: selectedItems.length }) + '&order=ASC&orderby=post__in&fetch_only=title,url,thumbnail';
