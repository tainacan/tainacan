...
export default class RelatedItemsModal extends React.Component {
    ...
    componentWillMount() {
        ...
        if (this.props.existingCollectionId) {
            ...
            this.setState({ 
                searchURL: tainacan_blocks.admin_url + 'admin.php?singleselectionmode=true&iframemode=true&page=tainacan_admin#/collections/'+ this.props.existingCollectionId + '/items/?status=publish'
            });
        } else {
    ...
    selectCollection(selectedCollectionId) {
        this.setState({
            ...
            searchURL: tainacan_blocks.admin_url + 'admin.php?singleselectionmode=true&iframemode=true&page=tainacan_admin#/collections/' + selectedCollectionId + '/items/?status=publish'
        });
