                    ...
                    if ( currentRoute.params.collectionId && collection ) {
                        ...
                        const collectionLinks = [
                            ...
                            },
                            {
                                ...
                                hide: !( tainacan_user.caps && (
                                    tainacan_user.caps.manage_tainacan
                                    || tainacan_user.caps.manage_tainacan_collection_all
                                    || tainacan_user.caps['manage_tainacan_collection_' + currentRoute.params.collectionId]
                                ) ) || adminOptions.hideNavigationCollectionReportsButton === 'true' || adminOptions.hideNavigationCollectionReportsButton === true
                            }
                        ];
