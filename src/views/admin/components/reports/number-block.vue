                    ...
                    <i
                        ...
                        <svg 
                            ...
                            <g
                                ...
                                <path
                                        id="path5508"
                                        style="fill:var(--tainacan-gray4, #505253);fill-opacity:1;stroke:none;stroke-width:0.332731;"
                                ...
                                <path
                                        id="path5461"
                                        style="fill:var(--tainacan-gray4, #505253);fill-opacity:1;stroke:none;stroke-width:0.332732;"
                                ...
                                <g 
                                        ...
                                        style="fill:var(--tainacan-gray4, #505253);fill-opacity:1;" />
                            </g>
                        </svg>
                    </i>
...
.number-block {
    ...
    .subtitle {
        ...
        padding-right: 0;
        margin: 0 auto;
        font-size: unquote('clamp(1.125rem, 2vw, 1.875rem)');
...
.visibility-charts {
    ...
    &>div {
        ...
        &:nth-child(5) {
            background-color: var(--tainacan-warning);
        }
        &:nth-child(6) {
            opacity: 0.35;
        }
