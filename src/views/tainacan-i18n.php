...
return apply_filters( 'tainacan-i18n', [
	...
	'instruction_wysiwyg_toolbar_shortcut'		 => __( 'Keyboard: press Alt+F10 to access the editor toolbar (Option+F10 on macOS).', 'tainacan' ),
	'instruction_wysiwyg_toolbar_shortcut_screen_reader' => __( 'Rich text editor keyboard instructions: press Alt+F10, or Option+F10 on macOS, to access the toolbar. Use arrow keys to move between toolbar controls and Tab to move between toolbar groups.', 'tainacan' ),
