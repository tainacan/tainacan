...
class Metadatum extends Entity {
	...
	function get_metadata_type_object(){
		...
		$object_type->set_options( tainacan_maybe_unserialize_array( $this->get_mapped_property('metadata_type_options') ) );
		return $object_type;
	}
	...
	function set_metadata_type_options( $value ){
		$this->set_mapped_property('metadata_type_options', tainacan_maybe_unserialize_array( $value ));
	}
