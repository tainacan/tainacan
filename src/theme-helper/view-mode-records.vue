                        ...
                        <div class="media">
                            <div class="list-metadata media-body">
                                <div 
                                    ...
                                    <img :src="item['thumbnail']['tainacan-medium-full'] ? item['thumbnail']['tainacan-medium-full'][0] : (item['thumbnail'].medium_large ? item['thumbnail'].medium_large[0] : thumbPlaceholderPath)">  
                                    <div 
                                            :style="{ 
