...
return [
	...
	'repository'                               => __( 'Repositório', 'tainacan' ),
	'collections'                              => __( 'Coleções', 'tainacan' ),
	'items'                                    => __( 'Items', 'tainacan' ),
	'fields'                                   => __( 'Metadados', 'tainacan' ),
	'filters'                                  => __( 'Filtros', 'tainacan' ),
	'categories'                               => __( 'Categorias', 'tainacan' ),
	'events'                                   => __( 'Eventos', 'tainacan' ),
	'collection'                               => __( 'Coleção', 'tainacan' ),
	'item'                                     => __( 'Item', 'tainacan' ),
	'field'                                    => __( 'Metadado', 'tainacan' ),
	'filter'                                   => __( 'Filtro', 'tainacan' ),
	'category'                                 => __( 'Categoria', 'tainacan' ),
	'event'                                    => __( 'Evento', 'tainacan' ),
	'term'                                     => __( 'Termo', 'tainacan' ),
	'terms'                                    => __( 'Termos', 'tainacan' ),

	// Actions
	'edit'                                     => __( 'Edição', 'tainacan' ),
	'new'                                      => __( 'Novo', 'tainacan' ),
	'add'                                      => __( 'Adicione', 'tainacan' ),
	'import'                                   => __( 'Importe', 'tainacan' ),
	'export'                                   => __( 'Exporte', 'tainacan' ),
	'cancel'                                   => __( 'Cancelar', 'tainacan' ),
	'remove'                                   => __( 'Remover', 'tainacan' ),
	'save'                                     => __( 'Salvar', 'tainacan' ),
	'next'                                     => __( 'Próximo', 'tainacan' ),
	'return'                                   => __( 'Anterior', 'tainacan' ),
	'see'                                      => __( 'Veja', 'tainacan' ),
	'search'                                   => __( 'Busca', 'tainacan' ),
	'advanced_search'                          => __( 'Busca Avançada', 'tainacan' ),
	'continue'                                 => __( 'Continuar', 'tainacan' ),
	'approve_item'                             => __( 'Aprovar', 'tainacan' ),
	'not_approve_item'                         => __( 'Not approve', 'tainacan' ),
	'add_one_item'                             => __( 'Adicionar um item', 'tainacan' ),
	'add_items_bulk'                           => __( 'Adicionar itens em massa', 'tainacan' ),
	'add_items_external_source'                => __( 'Adicionar itens externos', 'tainacan' ),
